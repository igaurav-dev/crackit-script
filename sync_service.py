...
from core.uploader import upload_to_api
...
def run_capture_cycle(token: str, include_image: bool = True) -> None:
    """Run a single capture -> OCR -> upload cycle. Silent on errors."""
    try:
        # Capture screen
        image_bytes, image_path = capture_screen()
